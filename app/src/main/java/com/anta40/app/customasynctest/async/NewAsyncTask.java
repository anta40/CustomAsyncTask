...
public abstract class NewAsyncTask<INPUT, PROGRESS, OUTPUT> {
     ...
     * @see #execute(Object)
     */
    public NewAsyncTask<INPUT, PROGRESS, OUTPUT> execute() {
        return execute(null);
    }
     ...
     */
    public NewAsyncTask<INPUT, PROGRESS, OUTPUT> execute(final INPUT input) {
        onPreExecute();
